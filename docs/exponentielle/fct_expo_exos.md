...
Attention, erreurs de corrections pour l'exercice 1   
_En attente de rectification par le site mathALÉA_


* question 4  
La réponse attendue est la c) car en plus de ce qui est expliqué $f(0)=-4$
...
Cette fiche doit vous aider à acquerrir des automatismes pour dériver des fonctions 
